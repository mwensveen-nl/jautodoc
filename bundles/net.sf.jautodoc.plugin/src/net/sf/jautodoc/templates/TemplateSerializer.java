...
public class TemplateSerializer implements Constants {
    ...
    private static final String TEMPLATE_ALLOW_EMPTY = "empty";
    ...
    private static void writeTemplates(DataWriter writer, TemplateSet templates) throws Exception {
        ...
        for (int i = 0; i < list.size(); ++i) {
            writeTemplateEntry(writer, list.get(i));
        }
    ...
    private static void writeTemplateEntry(DataWriter writer, TemplateEntry entry) throws Exception {
        ...
        writer.startElement(TEMPLATE_ALLOW_EMPTY);
        writer.characters(entry.isAllowEmpty() ? "Y" : "N");
        writer.endElement(TEMPLATE_ALLOW_EMPTY);
    ...
    private static class ContentHandler extends DefaultHandler {
        ...
        public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
            if (TEMPLATE_ENTRY.equals(qName)) {
                ...
                currentEntry.setAllowEmpty("Y".equals(attributes.getValue(TEMPLATE_ALLOW_EMPTY)));
            }
        ...
        public void endElement(String uri, String localName, String qName) throws SAXException {
            ...
            } else if (TEMPLATE_ALLOW_EMPTY.equals(qName)) {
                currentEntry.setAllowEmpty("Y".equals(buffer.toString()));
            }
