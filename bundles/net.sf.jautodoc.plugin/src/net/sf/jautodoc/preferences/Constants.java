...
public interface Constants {
    ...
    public static final String ALLOW_MARKED_EMPTY = "allow_marked_empty";
    ...
    public static final boolean DEFAULT_ALLOW_MARKED_EMPTY = false;
    ...
    public static final String DEFAULT_TAG_ORDER = "@author," +
            "@version," +
            "@param," +
            "@return," +
            "@throws," +
    ...
    public static final String DEFAULT_PKG_DOC_TEXT = "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\">" + LINE_SEPARATOR +
            "<html>" + LINE_SEPARATOR +
    ...
    public static final String DEFAULT_PKG_INFO_TEXT = "/**" + LINE_SEPARATOR +
            " * Provides..." + LINE_SEPARATOR +
            " */" + LINE_SEPARATOR +
    ...
    public static final String LABEL_ALLOW_MARKED_EMPTY = PreferenceMessages.getString("preferences.label.filter.allowmarkedempty"); //$NON-NLS-1$
    ...
    public static final String QUESTION_OVERWRITE_REPLACEMENT = PreferenceMessages.getString("preferences.label.question.overwritereplacement"); //$NON-NLS-1$
    ...
    public static final String CLEANUP_PREVIEW_JAVADOC_DISABLED = "package net.sf.jautodoc.example;" + LINE_SEPARATOR +
            LINE_SEPARATOR +
    ...
    public static final String CLEANUP_PREVIEW_JAVADOC_ENABLED = "package net.sf.jautodoc.example;" + LINE_SEPARATOR +
            LINE_SEPARATOR +
            "/**" + LINE_SEPARATOR +
